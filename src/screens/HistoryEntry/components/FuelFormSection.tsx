...
interface FuelFormSectionProps {
  control: Control<FuelFormData>;
  errors: FieldErrors<FuelFormData>;
  lastOdometer: number;
  fullTankSelected: boolean;
  isDark: boolean;
  colors: {
...
export function FuelFormSection({
  control,
  errors,
  lastOdometer,
  fullTankSelected,
            ...
            <Controller
              ...
              render={({ field: { onChange, value } }) => (
                <AppTextField
                  ...
                  error={(errors as { fuelAmount?: { message?: string } }).fuelAmount?.message}
                />
              )}
            />
          </View>
            ...
            <Controller
              ...
              render={({ field: { onChange, value } }) => (
                <AppTextField
                  ...
                  error={(errors as { fuelLiters?: { message?: string } }).fuelLiters?.message}
